...
def user_list(request):
    ...
    return render(request, 'socialaxy_chat/user_list.html', {'users': users})
...
def profile_view(request, username):
    ...
    return render(request, 'socialaxy_chat/profile.html', {
        'profile_user': user,
...
def thread_view(request, username=None, thread_id=None):
    ...
    return render(request, 'socialaxy_chat/thread.html', {
        'thread': thread,
        'messages': messages,
        'users': users,
...
def call_view(request, username):
    ...
    return render(request, 'socialaxy_chat/call.html', {
        'interlocutor': interlocutor,
    })
...
def log_in(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect(reverse('socialaxy_chat:user_list'))

    return render(request, 'socialaxy_chat/login.html', {'form': form})


@login_required
def log_out(request):
    logout(request)
    return redirect(reverse('socialaxy_chat:login'))
...
def sign_up(request):
    ...
    return render(request, 'socialaxy_chat/signup.html', {'form': form})
